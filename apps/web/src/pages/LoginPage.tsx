    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-primary-50 via-white to-primary-100/30 px-4">
      <div className="w-full max-w-md">
        <header className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-primary-500 to-primary-600 shadow-brand" aria-hidden="true">
        ...
        <main id="main-content">
          <div className="w-full max-w-md rounded-2xl border border-primary-100/50 bg-white p-8 shadow-soft-lg">
            <form onSubmit={handleSubmit} className="space-y-6" aria-label="Login form">
              {error && (
                <div role="alert" className="flex items-start gap-3 rounded-lg bg-red-50 p-4 text-sm text-red-600">
            ...
            <div className="mt-6 rounded-xl bg-primary-50 p-4 text-center" role="complementary" aria-label="Demo credentials">
