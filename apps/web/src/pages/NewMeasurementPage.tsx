    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="mx-auto max-w-2xl px-4 py-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Cabinet Dimensions */}
          <div className="rounded-xl bg-white p-6 shadow-sm">
            <h2 className="mb-4 font-semibold text-gray-900">Cabinet Dimensions</h2>
          ...
          {/* Countertop Details */}
          <div className="rounded-xl bg-white p-6 shadow-sm">
            <h2 className="mb-4 font-semibold text-gray-900">Countertop Details</h2>
          ...
          {/* Mounting & Faucet */}
          <div className="rounded-xl bg-white p-6 shadow-sm">
            <h2 className="mb-4 font-semibold text-gray-900">Mounting & Faucet</h2>
            <div className="grid gap-4 sm:grid-cols-2">
              <Select
          ...
          <div className="rounded-xl bg-white p-6 shadow-sm">
            <h2 className="mb-4 font-semibold text-gray-900">Existing Sink (if replacing)</h2>
            <div className="grid gap-4 sm:grid-cols-3">
              <Input
                label="Width (inches)"
                type="number"
          ...
          {/* Clearances */}
          <div className="rounded-xl bg-white p-6 shadow-sm">
            <h2 className="mb-4 font-semibold text-gray-900">Clearances</h2>
            <div className="grid gap-4 sm:grid-cols-3">
              <Input
          ...
          {/* Accessories */}
          <div className="rounded-xl bg-white p-6 shadow-sm">
            <h2 className="mb-4 font-semibold text-gray-900">Accessories</h2>
