    ...
    return (
      <div className="w-full">
        ...
        <select
          ...
          id={selectId}
          required={required}
          className={`block w-full rounded-lg border px-4 py-2 text-gray-900 focus:outline-none focus:ring-2 ${
            error
        ...
        {error && (
          <p id={`${selectId}-error`} className="mt-1 flex items-center gap-1 text-sm text-red-600" role="alert">
            <svg
